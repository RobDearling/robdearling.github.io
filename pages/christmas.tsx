...
const triviaQuestions: ChristmasTriviaQuestion[] = [
  ...
  {
    question:
      "What is the significance of the red and white stripes on a traditional peppermint candy cane?",
    answer:
      " The red stripes are said to represent the blood and sacrifice of Jesus Christ, and the white lines symbolize his purity.",
    day: 21,
  },
  {
    question:
        ...
        {currentQuestion ? (
          <div>
            <h3 className="mb-4 text-white text-2xl font-bold">
              Brightmines Christmas Trivia
            </h3>
            <h2 className="text-6xl text-green-500 font-bold">
              <div className="flex">{currentQuestion.question}</div>
            </h2>
